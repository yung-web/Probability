...
\item<4-> In many cases, continuous case is the some type of \bluef{limit} of its corresponding discrete case.
...
\eci
% $n$-th system $\xrightarrow{n \rightarrow \infty}$ limiting system
%
% \mycolorbox{
...
\onslide<3->{
Please check (looks like a boring algebra, see Problem 14 at pp 189):
...
\begin{cases}
0, & \text{if} \quad x \notin C \cr
\frac{\fx}{\cprob{C}}, &\text{if} \quad x \in C
\end{cases}
}}
