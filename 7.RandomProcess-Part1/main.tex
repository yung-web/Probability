...
\aleq{
\onslide<2->{\cprob{Y_k = t} &= \cbprob{X_t = 1 \text{ and $k-1$ arrivals during the first $t-1$ slots} }}\cr
\onslide<3->{&=\cbprob{X_t = 1} \cdot \cbprob{\text{$k-1$ arrivals during the first $t-1$ slots}}}\cr
