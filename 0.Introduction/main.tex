...
\plitemsep 0.12in
  ...
  \bci
\item<1-> \redf{non-real-time online ($\leq $50\%)} + \bluef{real-time offline/online  ($\geq$ 50\%)}

\item<2-> All lecture videos have already been pre-recorded.
  Available in \magenf{YouTube}.

\item<3->  \redf{non-real-time online}: Just watch anytime and anywhere you
  like. 
...
\item<1->Read \redf{ALL} the emails and sms from KLMS. 

\item<1-> Try to read \redf{ALL} of the textbook contents covered in the
  class. 
