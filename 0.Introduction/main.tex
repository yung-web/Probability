...
\item<1-> \bluef{KLMS}: All notifications and announcements (also sent to
  ...
  \item<2-> \bluef{KLMS}: Questions about course logistics 


    \item<3-> \bluef{KLMS}: Homework upload
   \item<3-> \bluef{KLMS}: Score upload and all the grade-related things

        \bigskip
        
      \item<4-> \redf{Campuswire}: Questions about course contents (should be in English)
