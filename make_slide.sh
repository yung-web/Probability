...
then
    (cd 6.Limit_Theorems; pdflatex -jobname=6.Limit-slide main.tex)				
elif [[ $1 -eq 7 ]]
then
    (cd 7.RandomProcess-Part1; pdflatex -jobname=7.RP-PartOne-slide main.tex)
elif [[ $1 -eq 8 ]]
then
    (cd 8.RandomProcess-Part2; pdflatex -jobname=8.RP-PartTwo-slide main.tex)		
elif [[ $1 -eq 9 ]]
then
